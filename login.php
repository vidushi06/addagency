			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
		            ...
		            <div class="form-group">
		            	<a href=""><button type="submit" name="submit" class="form-control btn btn-primary submit px-3">Sign In</button></a>
		            </div>
...
if(isset($_POST['submit'])){
	...
	$data = "SELECT * FROM user WHERE username = '$a' && password ='$b'";
